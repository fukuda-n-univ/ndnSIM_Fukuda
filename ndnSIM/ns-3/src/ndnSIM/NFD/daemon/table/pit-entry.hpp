...
public: // out-record
  ...
  bool
  getHashStartFlag() const{
	  return HashStartFlag;
  }
  ...
  bool
  getConsumerHashFlag(){
	  return ConsumerHashFlag;
  }

  const Entry&
  setConsumerHashFlag() {
	  ConsumerHashFlag=true;
	  return *this;
  }

  const Entry&
  resetConsumerHashFlag() {
	  ConsumerHashFlag=false;
	  return *this;
  }
...
private:
  ...
  mutable bool HashStartFlag ;
  mutable bool ConsumerHashFlag;
