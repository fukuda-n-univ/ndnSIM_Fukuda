...
PUBLIC_WITH_TESTS_ELSE_PRIVATE: // pipelines
 ...
 /* VIRTUAL_WITH_TESTS void
  onIncomingInterestForHash(Face& inFace, const Interest& interest);


  VIRTUAL_WITH_TESTS void
  onSearchByHash(const Face& inFace, const shared_ptr<pit::Entry>& pitEntry,const Interest& interest);
...
*/
  ...
  VIRTUAL_WITH_TESTS void
  onHashFail(Face& inFace, const Interest& interest);
  ...
  */
  ...
  VIRTUAL_WITH_TESTS void
  onIncomingRegistration(Face& inFace, const Data& data);
